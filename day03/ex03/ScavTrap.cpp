...
{
    std::string cmd;
    std::cout << "Hey new comer, I'll challenge you with one of my 3 entry test, if you fail you'll go back to where you're coming" << std::endl
              << std::endl;
    if (index == 0)
    {
    ...
    if (index == 1)
    {
        ...
        if (cmd.compare("ornithorynque") == 0)
            ...
            std::cout << "wrong, return to your mother skirts and learn franch !" << std::endl;
    }
    if (index == 2)
    {
